                ...
                {positions.map((p, i) => {
                  ...
                  return (
                    <tr key={i}>
                      ...
                      <td className="tabular-nums text-cyan-glow">${(p.current_price ?? 0).toFixed(4)}</td>
                      <td className={`tabular-nums font-bold ${positionPnl >= 0 ? "text-green-matrix" : "text-red-alert"}`}>
